...
class MyTestCaseIndex(unittest.TestCase):
    ...
    def test_investment(self):
        ...
        d = r.json()
        print("【最新融资事件数量： %s"%len(d['data']),'】')
        self.assertEqual(len(d['data']),8)

    def test_monthmarket(self):
        '''本月行情'''
    ...
    def test_tagdatahotdomainweek(self):
        '''热门领域-近一周'''
    ...
    def test_tagdatahotdomainmonth3(self):
        '''热门领域-近三个月'''
    ...
    def test_tagdatarisedomainweek(self):
        '''上升领域-近一周'''
    ...
    def test_tagdatarisedomainmonth(self):
        '''上升领域-近一个月'''
    ...
    def test_tagdatarisedomainmonth3(self):
        '''上升领域-近三个月'''
